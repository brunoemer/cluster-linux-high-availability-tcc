...
Dentro deste contexto, neste trabalho é realizado uma implementação de um ambiente de alta disponibilidade em uma empresa prestadora 
...
o gerenciamento e monitoramento do \textit{cluster}. Logo, foi pesquisado alguns \textit{softwares}, tanto para replicação de dados como para 
gerenciamento de \textit{cluster}, feito uma análise destes e adotado os melhores e mais adequados \textit{softwares} para o ambiente da empresa.
...
pode-se validar o ambiente de alta disponibilidade e avaliar os resultados obtidos desses testes, os quais foram positivos. Esses resultados 
