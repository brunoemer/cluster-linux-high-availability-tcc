...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  como exemplo de instruções de sistema; % entrada e saida (E/S)
 \end{itemize}
 ...
 Essas operações permitem um acesso controlado aos dispositivos, memória e processador. 
 ...
 lugar, e então o sistema operacional determina se essas operações não irão comprometer a integridade do sistema \cite{marinescu2013}.
