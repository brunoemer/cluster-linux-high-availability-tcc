...
está disponível para a plataforma utilizada. Deste modo, a virtualização possibilita executar diferentes sistema operacional no computador do 
...
porém utiliza um poder de processamento e memória RAM. Portanto, uma das grandes vantagens da virtualização é um melhor aproveitamento dos 
