...
Neste Capítulo será apresentado as diferentes classificações de máquinas virtuais, porém antes disso deve-se conhecer os diferentes 
...
Existe basicamente duas arquiteturas de hipervisor de sistema \cite{maziero2013}:
\begin{itemize}
...
diretamente (Figura \ref{fig:vms_arquiteturas}).
...
REESCREVER \cite{maziero2013} Pode-se dividir máquinas virtuais de sistema em dois tipos de estratégias distintas, são elas:
