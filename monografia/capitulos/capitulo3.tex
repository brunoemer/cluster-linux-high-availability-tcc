...
Virtualização utiliza abstração em sua arquitetura, por exemplo, ela transforma um disco físico em dois discos 
...
Existem várias formas de virtualização, portanto elas serão detalhas na Seção \ref{section:tiposvirt}.
