...
A Figura \ref{fig:interfaces_isa} mostra as diferentes camadas entre aplicações de usuários, bibliotecas, núcleo do sistema operacional e o 
\textit{hardware}.
...
executem como convidados sem a necessidade de serem modificados. ??? Assim permitindo, por exemplo, virtualizar um sistema operacional instalado 
diretamente em uma máquina física apenas copiando seu disco rígido, sem a necessidade de reinstalá-lo e reconfigurar todas as aplicações.
