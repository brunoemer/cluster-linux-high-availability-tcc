...
Deve-se entender os diferentes tipodes de interfaces existentes em sistemas de computação:
\begin{itemize}
 ...
 instruções de código de máquina. Esta interface é dividida em dois:
 \begin{itemize}
...
Máquina virtual de sistema também pode ser chamada de hipervisor ou monitor (\ac{VMM}), ...
