...
Características & DRBD & GlusterFS & HAST & Rsync\\\hline
Master/Slave & Sim & Sim & Sim & Não \\\hline
Replicação em tempo real & Sim & Sim & Sim & Não \\\hline
Número máximo de nós & Ilimitado & Ilimitado & 2 & Ilimitado \\\hline
Plataformas & ? & ? & FreeBSD & ? \\\hline
Virtualização & & & & \\\hline
\end{tabular}
\end{center}
\end{table}
