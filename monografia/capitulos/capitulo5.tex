...
No capítulo anterior foram detalhados todos os serviços que estão disponíveis na empresa, desta forma, neste capítulo serão apresentados os 
serviços considerados críticos para a empresa.

\section{Levantamento dos serviços críticos}
\label{section:servcrit}

Nesta seção será feita uma análise dos serviços fornecidos pela empresa, apresentados no capítulo anterior, destacando os serviços que foram 
considerados críticos para a empresa, sendo que para a seleção desses serviços críticos foram adotados alguns critérios. 
...
\begin{figure}[h!]
 ...
 \caption{Gráfico de requisições por segundo do sistema do provedor.}
...
A partir da implementação da solução de alta disponibilidade deste trabalho pretende-se atingir um \textit{Uptime} superior a 99,99\%.
...
Neste capítulo foram apresentados os serviços críticos que foram selecionados através da aplicação de critérios, sendo que esses critérios foram 
criados de acordo com a política de prioridades da empresa.
