...
No capítulo anterior foram detalhados todos os serviços que estão disponíveis na empresa. Nesta seção será feita uma análise desses serviços, 
destacando os serviços que foram considerados críticos para a empresa. Para a seleção dos serviços críticos foram adotados alguns critérios. 
Esses critérios foram baseados em ??. 
%tcc geordano - bom tempo, orientador maria de fatima, Monitoramento_snmp_redes_Geordano_Arend.pdf
%criterios para avaliacao de softwares de monitoramento de fibra
%EX: Os pesos para cada critério foram definidos de acordo com a sua importância para o
%ambiente de monitoramento da Bom Tempo Telecom e em conjunto com a direção da
%empresa, sendo o valor 3 considerado pouco importante, o valor 6 como sendo de média
%importância e o valor 9 para critérios muito importantes.
Tem-se os critérios listados abaixo:
\begin{itemize}
...
A partir da análise feita anteriormente decidiu-se que os servidores mais relevantes para a empresa são:
\begin{itemize}
