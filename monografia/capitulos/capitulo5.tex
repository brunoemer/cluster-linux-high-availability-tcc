...
das configurações, assim necessitando de um nó \textit{master} e um nó \textit{master candidate}.
...
complexa para configurar e manter. Além disso, tem como requisito três nós para armazenamento outro exclusivo para administração.
...
Failover e failback & Sim & Não & Sim & Não \\\hline
