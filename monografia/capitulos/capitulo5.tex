...
...
É possível implementar essa solução com a ferramenta \textit{Heartbeat}, porém, desta forma seria necessário criar um conjunto de \textit{scripts} 
...
Sincronismo de configuração dos nós & Sim & & & Não \\\hline
Failover e failback & Sim & & & Não \\\hline
Nível de detecção e recuperação & Nó e recurso & & & Nó \\\hline
Plataformas & & & & \\\hline
...
e de código aberto mais completa e flexível encontrada. 
