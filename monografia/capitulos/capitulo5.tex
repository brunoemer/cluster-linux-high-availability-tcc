...
os clientes e funcionários utilizam. O objetivo de um provedor é fornecer uma navegação de qualidade aos seus clientes, sendo assim, o 
\ac{DNS} é fundamental para essa navegação. O primeiro critério desse serviço é a quantidade de clientes que ele possui, que é 
aproximadamente 9000, além disso possui 65 funcionários. Outro importante critério que pode ser aplicado ao \ac{DNS} recursivo é o número de 
...
compara os principais servidores da empresa através de requisições \ac{UDP}, onde pode-se claramente perceber que o servidor \textit{Passata}
possui um grande número de requisições \ac{UDP}, o qual fornece o serviço de \ac{DNS} recursivo primário. Assim, esse serviço se torna o 
...
\begin{figure}[h!]
 ...
 \caption{Gráfico de comparação de requisições UDP entre os principais servidores.}
...
Esse serviço é importante para a navegação dos clientes do provedor, pois esse é o responsável pela autenticação de 
...
O sistema do provedor é responsável pela maior parte das operações do provedor. De fato, esse sistema é
...
Esse serviço tem relevância para a empresa e para o provedor, pois permite a comunicação entre os clientes e os funcionários, 
ou seja, o servidor \textit{SimplesIP} é responsável por permitir o atendimento a clientes para fins de suporte técnico, comunicação interna entre 
...
requisições \ac{UDP}, pois esse servidor também encontra-se entre os maiores. Ele pode ser observado na Figura \ref{fig:servico_tcp} e na Figura 
\ref{fig:servico_udp}.
