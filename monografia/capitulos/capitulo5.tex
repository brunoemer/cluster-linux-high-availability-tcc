...
\begin{itemize}
 ...
 requisições por segundo, que chega aproximadamente a 1150 (Figura \ref{fig:passata_day}). De acordo com a Figura \ref{fig:servico_udp}, que 
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=420px]{img/servico_udp.eps}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=420px]{img/servico_elemento.eps}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=420px]{img/servico_tcp.eps}
