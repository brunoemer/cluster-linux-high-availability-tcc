...
Alta disponibilidade é uma técnica conhecida, sendo cada vez mais empregada em ambientes computacionais. O objetivo de prover
...
\begin{itemize}
 ...
 falhas. O seu principal objetivo é alcançar a dependabilidade, indicando uma boa qualidade de serviço \cite{costa2009}. A tolerância a falhas é 
...
de uma falha sem afetar o funcionamento do sistema.

A tolerância a falhas é implementada utilizando redundância (Seção \ref{section:redundancia}). 
...
\begin{itemize}
 ...
 monitoramento de serviços que faz um teste em cada serviço. No caso de ocorrência uma falha em um serviço, uma ação corretiva 
...
Neste Capítulo foram descritos os princípais conceitos de alta disponibilidade e conceitos relacionados. Como mencionado anteriormente, 
