...
O procedimento deste teste é:
\begin{itemize}
 \item Acessar o terminal do servidor de monitoramento;
 \item Executar comando \textit{ping} e medir tempo de indisponibilidade (script no Apêndice \ref{ap:scriptindisp});
...
Deste modo, criou-se a Tabela \ref{tab:teste1resultados} a qual possui os dados resultantes do teste.
...
Destaca-se que o \ac{MTTR} seria significativamente maior caso fosse necessário reconfigurar a máquina virtual, reinstalar as aplicações,
configurá-las e restaurar o \textit{backup}. Dependendo da aplicação, a indisponibilidade poderia ser maior que um 24 horas.
