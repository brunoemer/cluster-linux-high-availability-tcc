...
Esse teste simula falhas de \textit{software} do nó do \textit{cluster} ou do \textit{software} de virtualização. Esse tipo de situação também
pode ocorrer em uma manutenção emergencial, onde, por exemplo, é preciso desligar o servidor.
...
-Medicao da disponibilidade dos serviços críticos por 1 mes (outubro) e comparar ao mês de setembro no ambiente antigo com 
