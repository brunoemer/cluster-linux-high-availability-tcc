...
A segunda configuração é feita no arquivo \textit{/etc/default/o2cb}, que faz o carregamento do \textit{driver} no \textit{boot} e a
definição do nome do cluster para inicialização.
