...
infraestrutura de \ac{TI}. Além disso, percebe-se um aumento significativo no número de operações \textit{on-line} que são realizados, 
...
\begin{itemize}
 ...
 \item Capítulo \ref{cap:projetoimplementacao}: é feito a identificação dos serviços críticos e apresenta a solução de alta disponibilidade 
 utilizando virtualização no cenário da empresa;
 \item Capítulo \ref{cap:conclusao}: apresenta a conclusão e o cronograma para a implementação da solução proposta.
\end{itemize}
