...
A empresa fornece serviços diversos, desde hospedagens de sites até \aca{DNS} recursivo para o provedor de Internet. Atualmente sete servidores 
...
\begin{itemize}
 ...
 fornecem o serviço de \ac{DNS} \cite{tanenbaum2011} e \aca{NAT} \cite{kurose2006} para navegação \aca{IPv6} \cite{ipv6} do provedor;
...
\begin{itemize}
 ...
 \aca{SMTP} \cite{kurose2006}; recebimentos de \textit{e-mails} através dos protocolos \aca{POP} \cite{kurose2006} e \aca{IMAP} \cite{kurose2006}; 
...
Neste capítulo foi apresentada a infraestrutura de \ac{TI} da empresa. No próximo capítulo será feita a identificação dos serviços mais críticos 
