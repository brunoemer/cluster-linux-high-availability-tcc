...
\textit{hardware} que está sendo utilizado. No próximo capítulo serão apresentados os serviços que são considerados críticos, além disso,
será apresentada o projeto de implementação do ambiente de alta disponibilidade, para tanto será definido algumas ferramentas.
