...
\end{figure}
 ...
 outros. Esse sistema não tem um impacto direto para os clientes, porém tem um grande impacto para os funcionários da empresa e do provedor. 
 ...
 principal do provedor e ficam aproximadamente entre 3 e 4 por segundo, conforme Figura \ref{fig:soldi_week}. Além disso, a empresa mantém outros
...
\end{figure}
 ...
 No mês de maio de 2016 a empresa recebeu 15922 ligações no total, com duração total de 67:40:14, sendo que essas ligações são utilizadas por 
 todos o setores do provedor e também da empresa, além disso no mesmo mês foram efetuadas 674 ligações entre funcionários. O gráfico da Figura 
 \ref{fig:simplesip_week} mostra a quantidade de canais ativos simultaneamente no servidor de telefonia, com isso pode-se perceber que existem 
 de 20 e 30 ligações que são feitas durante o horário comercial.
\end{itemize}
