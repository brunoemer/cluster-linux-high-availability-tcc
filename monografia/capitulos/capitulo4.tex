...
O servidor Brina possui X?? \ac{VM}s como pode ser visto na Figura \ref{fig:serv_brina} juntamente com seus respectivos serviços. 
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=230px]{img/serv_brina.eps}
...
O servidor Brina possui onze \ac{VM}s como pode ser visto na Figura \ref{fig:serv_fulmine} juntamente com seus respectivos serviços. 
Esses serviços são listados a seguir:
\begin{itemize}
...
O servidor Piova possui oito \ac{VM}s como pode ser visto na Figura \ref{fig:serv_piova} juntamente com seus respectivos serviços. 
Esses serviços são listados a seguir:
\begin{itemize}
...
O servidor chamado Raggio executa doze \ac{VM}s (Figura \ref{fig:serv_raggio}), que fornecem os serviços de virtualização para algumas empresas,
...
O servidor Tempesta possui X?? \ac{VM}s como pode ser visto na Figura \ref{fig:serv_tempesta} juntamente com seus respectivos serviços. 
Esses serviços são listados a seguir:
\begin{itemize}
...
O servidor Tuono possui oito \ac{VM}s como pode ser visto na Figura \ref{fig:serv_tuono} juntamente com seus respectivos serviços. 
Esses serviços são listados a seguir:
\begin{itemize}
...
O servidor Venti possui cinco \ac{VM}s como pode ser visto na Figura \ref{fig:serv_venti} juntamente com seus respectivos serviços. 
Esses serviços são listados a seguir:
\begin{itemize}
