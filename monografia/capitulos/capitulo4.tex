...
\end{figure}
 ...
 todos o setores do provedor e também da empresa. O gráfico da Figura \ref{fig:simplesip_week} mostra a quantidade de canais ativos simultaneamente 
 no servidor de telefonia, com isso pode-se perceber que existem de 20 e 30 ligações que são feitas durante o horário comercial.
\end{itemize}
