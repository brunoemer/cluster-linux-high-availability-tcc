...
\begin{itemize}
 ...
 número de requisições por segundo (Figura \ref{fig:passata_day}), que é o maior entre todos os outros serviços;
 
\begin{figure}[h!]
 \centering
 \includegraphics[width=300px]{img/passata_day.eps}
