...
\begin{itemize}
 ...
 o serviço de Webmail (\ac{PHP}) e Anti-spam. Destaca-se que grande parte das contas de \textit{e-mail} estão ociosas pois são oferecidas 
 ...
 que foi descrito na Seção \ref{section:serv_fulmine}), sendo que ele fornece acesso a sites \textit{Web} desenvolvidos com a linguagem \ac{PHP}. 
