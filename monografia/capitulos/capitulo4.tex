...
Neste trabalho será feito um estudo sobre uma empresa que fornece serviços de hospedagens, 
sabendo que ela atualmente possui redundância de refrigeração 
e energia. Assim, essas redundâncias tem como objetivo prover um ambiente físico estável e confiável.

Apresentar empresa, cidade, clientes, num funcion, etc...
...
(Seção \ref{section:ambiente}); a estrutura lógica???, com a relação de servidores físicos e virtuais, e todos os 
serviços fornecidos pela empresa (Seção \ref{section:estlog}); e por fim a seleção dos serviços críticos (Seção \ref{section:servcrit}).
