...
\begin{tabular}{|l|p{4cm}|p{4cm}|l|}\hline
 & \textbf{Tempo de indisponibilidade média} & \textbf{Desvio padrão da indisponibilidade} & \textbf{Latência média} \\\hline
...
\begin{table}[h!]
\caption{Tabela de disponibilidade e tempo de indisponibilidade do período de 13 dias.}
\label{tab:teste3resultados}
\begin{center}
