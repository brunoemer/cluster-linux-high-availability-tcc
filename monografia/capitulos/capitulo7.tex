...
(utilizado um \textit{script} para facilitar a medição, ele está localizado no Apêndice \ref{ap:scriptindisp}), ou seja, durante a execução de 
cada teste foi executado um \textit{ping} com duração de 5 minutos para cada servidor, para os dois nós e para a máquina virtual.
