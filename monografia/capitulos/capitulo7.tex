...
Como pode-se também observar na Figura \ref{fig:projeto_discos} todoas as operações de escritas realizadas são replicadas no outro nó do
\textit{cluster}, através do sistema de arquivos distribuídos \ac{OCFS2}. ?? COLOCAR MAIS SOBRE QUADRO PONTILHADO
