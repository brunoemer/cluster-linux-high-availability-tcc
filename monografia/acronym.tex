...
\DeclareAcronym{DRBD}{
  short = DRBD,
  alt   = DRBD (\textit{Distributed Replicated Block Device}),
...
\DeclareAcronym{UTP}{
  short = UTP,
  alt   = UTP (\textit{Unshielded Twisted Pair}),
  long  = \textit{Unshielded Twisted Pair},
  class = abbrev
}
\DeclareAcronym{DDoS}{
  short = DDoS,
  long  = \textit{Distributed Denial-of-Service},
  class = abbrev
}
