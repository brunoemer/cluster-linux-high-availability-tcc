...
\DeclareAcronym{NRPE}{
  short = NRPE,
  long  = \textit{Nagios remote p ??},
  class = abbrev
}
\DeclareAcronym{SVN}{
  short = SVN,
  long  = \textit{Sync version n ??},
  class = abbrev
}
\DeclareAcronym{PHP}{
  short = PHP,
  long  = \textit{Prep hypertext programming ??},
  class = abbrev
}
\DeclareAcronym{ASP}{
  short = ASP,
...
\DeclareAcronym{SMTP}{
  short = SMTP,
  long  = \textit{Send mail t protocol ??},
  class = abbrev
}
\DeclareAcronym{POP}{
  short = POP,
  long  = \textit{P  protocol ??},
  class = abbrev
}
\DeclareAcronym{IMAP}{
  short = IMAP,
  long  = \textit{I  protocol ??},
  class = abbrev
}
\DeclareAcronym{XMPP}{
  short = XMPP,
  long  = \textit{X message p protocol ??},
  class = abbrev
}
\DeclareAcronym{SSH}{
  short = SSH,
